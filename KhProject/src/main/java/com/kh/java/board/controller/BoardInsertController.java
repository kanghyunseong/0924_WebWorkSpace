...
public class BoardInsertController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// request.getParameter로는 값을 뽑을 수 없음

		// 스텝 0) 요청이 mutipart방식으로 잘 왔는지 확인
		if (ServletFileUpload.isMultipartContent(request)) {
			 ...
			 * 단위 정리
			 * 
			 * bit X 8 => Byte X 1024 => KByte X 1024 => MByte X 1024 => GByte X 1024 =>
			 * TByte X 1024 => PByte
			 * 
			 * 10MegaByte
			 */
			 ...
			 * [ 표현법 ]
			 * 
			 * MultiPartRequest multiRequest = new MultiRequest(request, 저장경로, 용량제한, 인코딩,
			 * 파일명을 수정해주는 객체);
			 * 
			 ...
			 * A) 똑같은 파일명이 있을 수 있음
			 * 
			 * -> 파일명에 한글/ 특수문자 / 공백문자 포함 경우 서버에 따라 문제가 발생
			 */
