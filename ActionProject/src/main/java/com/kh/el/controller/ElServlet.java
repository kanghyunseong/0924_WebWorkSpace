...
public class ElServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// JSP로 포워딩할 때 request에 담아서 보내줬음! --> Servlet내장 객체/ Scope객체

		// apllication / session / request / page

		/*
		 * 1. application scope : ServletContext
		 * 
		 * 한 애플리케이션 당, 단 한 개 존재하는 객체 이 영역에 데이터를
		 * 
		 * 담으면 애플리케이션 전역에서 사용 가능
		 * 
		 ...
		 * 
		 * 값이 한 번 담기면 서버를 멈추거나, 세션을 비우거나, 브라우저가 닫히기 전까지 사용 가능
		 * 
		 ...
		 * JSP페이지 내에서만 사용 가능
		 * 
		 * => 위 객체들에 속성을 추가할때는 .setAttribute("키", 밸류);
		 * 
		 * => 속성값을 뽑을때는 .getAttribute("키");
		 * 
		 * => 속성값을 지울때는 .removeAttribute("키");
		 */
